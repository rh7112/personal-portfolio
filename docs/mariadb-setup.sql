...
('Personal Portfolio', 'Built this portfolio to expand knowledge of Next.js, HeroUI, and MariaDB while showcasing professional experience.', '/images/projects/10.png', 'Personal Projects', 'personal-projects', 'sky', 'Next.js, HeroUI, MariaDB', 1, 1),
...
('Synology NAS Home Server', 'Configured a Synology NAS as a home server, including MariaDB hosting, Surveillance Station and IP camera setup, port forwarding, DDNS, and Cloudflare integration.', NULL, 'Personal Projects', 'personal-projects', 'sky', 'MariaDB, Surveillance Station, DDNS, Cloudflare, Linux', 0, 1),
('Plex Media Server', 'Built a home media server with Plex, Radarr, Sonarr, and Lidarr for media management, Discord webhooks for each *arr app, and WinNUT/BackUPS for graceful shutdown during power outages.', NULL, 'Personal Projects', 'personal-projects', 'sky', 'Plex, Radarr, Sonarr, Lidarr, WinNUT', 0, 1),
...
('EPA Reporting', 'A compliance-focused reporting workflow that consolidated multiple sources into a more maintainable experience.', '/images/projects/ppi-epa-reporting.svg', 'Packaging Personified, Inc.', 'packaging-personified', 'sky', 'Retool, Excel, DL4, PKP, Access', 1, 1),
...
('Beverage Kiosks', 'Rewrote the shared beverage kiosk application to improve consistency and maintainability across multiple kiosk locations.', '/images/projects/18.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 0, 1),
('Crescendo Cafe Kiosk', 'Rebuilt the cafe management system with Retool to improve usability, performance, and long-term maintainability.', '/images/projects/16.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 0, 1),
('Consumer Audio', 'Reworked the round-robin assignment flow for less specialized audio equipment sales to reduce sales engineer workload and increase throughput.', '/images/projects/4.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', '4D', 0, 1),
('Distribution Center Cookout Giveaway', 'Built a badge-based raffle application for the Sweetwater Distribution Center to manage employee prizes and winners at a cookout event.', '/images/projects/22.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 0, 1),
('End of Day Notes', 'Created a shared handoff application for the Guitar Gallery to centralize daily notes and improve shift transitions.', '/images/projects/14.png', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 0, 1),
('Gear Exchange - Braintree Implementation', 'Integrated PayPal''s Braintree payment processing into Gear Exchange, enabling secure transactions and helping bring the platform to life. Gear Exchange saw over $1M in sales within its first few months.', '/images/projects/2.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', '4D, PayPal Braintree GraphQL API', 1, 1),
('Gitlab Permissions Lookup', 'Created a tool that uses the GitLab REST API to surface repository ownership and maintainers for support teams.', '/images/projects/15.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool, GitLab API', 0, 1),
('In-House Credit Freezing/Thawing', 'Modified the logic related to freezing and thawing credits to comply with Indiana state law and improve financial accuracy.', '/images/projects/5.png', 'Sweetwater Sound', 'sweetwater-sound', 'sky', '4D', 0, 1),
('Inventory Variances', 'Built an app to help the Music Store track inventory variances and maintain stock more effectively.', '/images/projects/13.png', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 0, 1),
('Mentor Management Application', 'Built with the Orbital class team, this app helped mentees select mentors over a set period to support learning and skill-building.', '/images/projects/11.png', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'C#/.NET, Go/GCP', 0, 1),
('Personalized Tile Promotions', 'Rewrote the Personalized Tile Promotions application to show targeted promotions based on browsing history.', '/images/projects/7.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 0, 1),
('Price Management Platform', 'Built a pricing-tracking tool for the merchandising team that helped sharpen competitor pricing insight, driving $4M in increased revenue in under a month.', '/images/projects/6.png', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 1, 1),
('Search Miner', 'Developed a tool to help the SEO engineer analyze Sweetwater.com search results and improve website health and performance.', '/images/projects/8.png', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 0, 1),
('Tax Exemption Certification Management System (ECMS)', 'Sole developer on implementing Avalara''s Exemption Certificate Management System, saving the tax team the equivalent of 160+ hours of validating certificates per month.', '/images/projects/3.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', '4D, ECM/ECMS API', 1, 1),
('Turkey Handout Application', 'Delivered a Thanksgiving turkey/gift card handout tool within 72 hours, letting the campus events team serve 2,500 employees.', '/images/projects/1.png', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 1, 1),
('Wavelengths Salon & Spa Kiosk', 'Provided support and maintenance for the Wavelengths Salon and Spa internal platform with a focus on usability and bug fixes.', '/images/projects/17.jpg', 'Sweetwater Sound', 'sweetwater-sound', 'sky', 'Retool', 0, 1),
...
('Accessibility Website', 'Built a website teaching accessibility concepts using Agile methodologies as part of a project management course.', '/images/projects/21.jpg', 'Purdue University', 'purdue-university', 'sky', 'React', 0, 1),
('DementiaTrack', 'A senior capstone project that analyzed patient sensor data to explore sensor-based health monitoring and machine learning insights.', '/images/projects/9.jpg', 'Purdue University', 'purdue-university', 'sky', 'Python, React', 0, 1),
('Flashcards Android Application', 'Built a Flashcards app as part of a software engineering course.', '/images/projects/19.jpg', 'Purdue University', 'purdue-university', 'sky', 'Kotlin, Android Studio', 0, 1),
('Website Development - Final Project', 'Built a website for Black''s Concrete Construction as a functional final project for coursework.', '/images/projects/12.png', 'Ivy Tech', 'ivy-tech', 'sky', 'HTML5, CSS3', 0, 1),
('Phase 10 Dice', 'Developed the Phase 10 Dice game as the final project for an introductory programming course.', '/images/projects/20.jpg', 'Ivy Tech', 'ivy-tech', 'sky', 'C++', 0, 1),
