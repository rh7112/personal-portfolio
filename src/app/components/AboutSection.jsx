...
export default async function AboutSection() {
  ...
  const items = await conn.query(
    "SELECT title, description FROM sweetwater_teams"
  );
  conn.release();
  ...
  return (
    <div>
      <h2>About Me</h2>
      <ExperienceSection sweetwaterItems={items} />
    </div>
  );
}
...
// async function getSweetwaterItems() {
//   let conn;
//   try {
//     conn = await pool.getConnection();
//     const rows = await conn.query(
//       "SELECT title, description FROM sweetwater_accordion_items"
//     );
//     return rows;
//   } catch (err) {
...
// export default async function AboutSection() {
//   const sweetwaterAccordionItems = await getSweetwaterItems();
...
//           {SkillCard(
//             Si4D,
//             "Fourth Dimensional Programming (4D)",
//             "Experienced"
//           )}
...
//               do, and it’ s what drives me to solve problems with care,
//               intention, and integrity— both in life and in code.
//             </p>

//             <p className="text-base lg:text-lg">
//               Professionally, I’ m a software engineer with 4 + years of
//               experience building internal tools and business applications that
//               make work easier, faster, and more reliable.I specialize in full -
//               stack development with JavaScript, Python, SQL, and Retool, and I’
//               ve delivered high - impact solutions— from a price management
//               platform that boosted revenue by $4M, to system integrations that
//               gave back entire workdays to internal teams.
//             </p>

//             <p className="text-base lg:text-lg">
//               I thrive when bridging the gap between non - technical
//               stakeholders and clean, scalable code.I’ ve worked in Agile,
//               Scrum, Kanban, and Waterfall environments, and I’ m comfortable
//               wearing multiple hats— from frontend to backend, deployment to
//               support.
//             </p>
...
//               Plex server just for fun.I value clarity, consistency, and
